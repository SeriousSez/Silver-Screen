...
namespace SilverScreen.Domain.Recruitment
{
 ...
 public enum RecruitmentDestination{StageSchool,ScriptOffice}
 [Serializable] public sealed class Candidate
 {
  public PersonProfile Person{get;} public int SalaryExpectation{get;} public RecruitmentDestination Destination{get;} public CandidateStatus Status{get;private set;} public int WaitingMinutes{get;private set;} public int WaitingPositionIndex{get;private set;}=-1;
  public Candidate(PersonProfile person,int salaryExpectation){Person=person??throw new ArgumentNullException(nameof(person));SalaryExpectation=Math.Max(1,salaryExpectation);Destination=person.ProfessionalRole==ProfessionalRole.Writer?RecruitmentDestination.ScriptOffice:RecruitmentDestination.StageSchool;Status=CandidateStatus.Arriving;}
